...
import ar.edu.unq.po2.tpObserver.SistemaReferenciaYPublicacion;

import static org.mockito.Mockito.*;

class SistemaReferenciaYPublicacionTest {
	...
	void setUp() throws Exception {
		...
		sistema.cargarInvestigadores(investigador);
	...
	void testAgregarArticulos() {
		...
		assertEquals(Arrays.asList(articulo1, articulo2), sistema.getArticulos());

	}

	@Test
	void testAgregarArticuloYNotificar() {

		sistema.cargarArticulo(articulo1);
		verify(investigador).recibirAviso();
...
//		sistema = new SistemaReferenciaYPublicacionTest();
